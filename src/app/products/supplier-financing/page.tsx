...
export const metadata: Metadata = {
    title: 'Supplier Financing Solutions | Neenv',
    description: 'Strengthen your supply chain with Neenv\'s supplier financing. Help your suppliers access early payments while you extend your payment terms.',
    keywords: ['supplier financing', 'vendor financing', 'early payment', 'reverse factoring', 'supply chain finance India'],
    openGraph: {
        title: 'Supplier Financing Solutions | Neenv',
        description: 'Strengthen your supply chain with Neenv\'s supplier financing. Help your suppliers access early payments while you extend your payment terms.',
        url: 'https://www.neenvfin.com/products/supplier-financing',
        siteName: 'Neenv',
        type: 'website',
    },
    alternates: {
